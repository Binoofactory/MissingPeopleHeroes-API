	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.withClassAnnotation(RestController.class)
						.or(RequestHandlerSelectors.basePackage("com.binoofactory.mph.web.vo")))
				.paths(PathSelectors.any())
				.build()
				.tags(
						// auth
						new Tag("인증 토큰", "/api/t1/auth/")
						// boards
						, new Tag("게시판", "/api/t1/board")
						// extra-api
						, new Tag("실종자", "/api/t1/info/missing-people"))
				.apiInfo(apiInfo())
