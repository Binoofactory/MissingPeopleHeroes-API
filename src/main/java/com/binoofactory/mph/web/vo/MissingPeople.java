...
public class MissingPeople implements IFBaseVO{
	...
	public @ApiModelProperty(value = "현재 나이", required = false, example = "1") Integer ageOfNow;
	public @ApiModelProperty(value = "실종 당시 나이", required = false, example = "1") Integer ageAtTime;
	...
	public @ApiModelProperty(value = "실종 당시 추가 정보(ETC) ", required = false, example = "1") String feature;
    ...
    public MissingPeople(MissingPeopleVO missingPeopleVO) {
        ...
        this.ageOfNow = missingPeopleVO.ageOfNow == null ? 0 : missingPeopleVO.ageOfNow;
        this.ageAtTime = missingPeopleVO.ageAtTime == null ? 0 : missingPeopleVO.ageAtTime;
        ...
        this.feature = missingPeopleVO.feature == null ? "" : missingPeopleVO.feature;
    }
}
